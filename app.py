        ...
        f"""
            <div style="text-align: center; margin: 0 auto;">
              ...
              <p style="margin-bottom: 10px; font-size: 94%; line-height: 23px;">
                This Model is using Stable Diffusion XL which is latest text-to-image model from StabilityAI. 
                <br/>
    ...
    with gr.Group():
        ...
        gr.HTML(
            f"""
                <div class="footer">
                    <p>
                        This space uses {model_key_base} model{" with " + lcm_lora_id + " LCM LoRA" if enable_lcm else ""}. - Gradio Demo by Team CU T2I Generation <br/>
                    </p>
                </div>
           """
        )
